...
/**
 * Class Pacman
 * Represent pacman on the map and all his functions
...
public class Pacman extends Entite {
	...
	public Pacman move_pacman(int code) {
		...
		// Si on a reçu un autre code que 1 2 3 ou 4, alors on ne change pas de direction
